...
$(document).ready(function(){
 ...
 function editar(idDireccion){
    ...
    $.post("../../controller/proveedor/proveedorController.php?op=mostrar", {idDireccion : idDireccion}, function (data) {
        console.log(data);
        data = JSON.parse(data);
        $('#idDireccion').val(data.idDireccion);
        $('#nombreProveedor').val(data.nombreProveedor).prop('disabled', true);
...
function guardaryeditar(e){
    ...
    swal({
        ...
        if (!isConfirm) return;
        $.ajax({
            url: "../../controller/proveedor/proveedorController.php?op=guardaryeditar",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
...
$(document).ready(function(){
    tabla=$('#usuario_data').dataTable({
        ...
        "ajax":{
            url: '../../controller/proveedor/proveedorController.php?op=listar',
            type : "post",
            dataType : "json",						
            error: function(e){
...
function eliminar(idDireccion){
    swal({
        title: "Estas por eliminar un proveedor",
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.post("../../controller/proveedor/proveedorController.php?op=eliminar", {idDireccion : idDireccion}, function (data) {
