...
<body class="with-side-menu theme-side-caesium-dark-caribbean">
	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
				<button type="button" id="btnnuevo" class="btn btn-inline btn-primary">Agregar nuevo Sensor</button>
				<table id="usuario_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
					<thead>
						<tr>
							<th style="width: 10%;">Empresa</th>
							<th style="width: 10%;">Numero de Serie</th>
	...
	<?php require_once("modalSensores.php");?>

	<?php require_once("../MainJs/js.php");?>
	
	<script type="text/javascript" src="sensores.js"></script>
